...
import { safeAccess, shortenTransactionHash, getEtherscanLink } from '../utils'
...
function renderSnackbarContent(hash, chainId) {
  return (
    <article>
...
export function useTransactionAdder() {
  ...
  return useCallback(
    (response, customData = {}) => {
      ...
      enqueueSnackbar(renderSnackbarContent(hash, chainId))
    },
